...
/**
 * ChattyLib の認証情報を EncryptedSharedPreferences で安全に管理するユーティリティ。
 */
public class ChattyLibPreferences {

    private static final String PREF_FILE = "chattylib_credentials";
    private static final String KEY_LOGIN_ID = "login_id";
    private static final String KEY_PASSWORD = "password";

    private ChattyLibPreferences() {}
    ...
    private static SharedPreferences getPrefs(Context context) {
        try {
            ...
            android.util.Log.e("ChattyLibPreferences", "Failed to create EncryptedSharedPreferences", e);
            return null;
        }
    }
}
