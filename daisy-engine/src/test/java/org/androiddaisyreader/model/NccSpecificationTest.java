...
public class NccSpecificationTest extends TestCase {
    ...
    public void testReadFromFileJa() throws IOException {
        File inputFile = new File("./sdcard/files-used-for-testing/testfiles/minidaisyaudiobook/ncc-ja.html");
        DaisyBook book = NccSpecification.readFromFile(inputFile);
        assertEquals("Shift_JISテスト", book.getTitle());
    }
