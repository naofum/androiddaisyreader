...
public class PackageDocumentBase {
	...
	public static final String NAMESPACE_MEDIA = "http://www.idpf.org/epub/vocab/overlays/#";
	public static final String dateFormat = "yyyy-MM-dd";
	public static final String OPF_PACKAGE_VERSION = "3.0";
	...
	protected interface OPFValues {
		...
		String media_duration = "media:duration";
	}
}