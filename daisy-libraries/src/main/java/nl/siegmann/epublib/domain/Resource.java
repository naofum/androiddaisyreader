...
public class Resource implements Serializable {
	 ...
	 * Uses the resource's input encoding.
	 *
	 * @return the contents of the Resource as Reader.
	 * @throws IOException
	 */
	public Reader getReader() throws IOException {
		return new InputStreamReader(new ByteArrayInputStream(getData()), getInputEncoding());
	}

	/**
	 * The EPUB3 manifest properties of this resource (e.g. "nav", "cover-image").
	 * May be null when no properties apply.
	 *
