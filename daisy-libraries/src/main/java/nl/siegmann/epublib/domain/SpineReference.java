...
public class SpineReference extends ResourceReference implements Serializable {
	...
	/**
	 * The id of the SMIL media overlay resource associated with this spine item.
	 * EPUB3 media-overlay attribute of the itemref element.
	 *
	 * @return the id of the media overlay resource, or null when none is set.
	 */
